...
{
	TEST_CASE("Vector_default_ctor_zero_size", "[simple]")
	{
		Vector<Real> b, c(0);
		REQUIRE(0 == b.size());
		REQUIRE(0 == c.size());
	...
	TEST_CASE("Vector_ctor_init_elems_to_zero", "[simple]") {
		Vector<Real> a(3);
	...
	TEST_CASE("Vector_ctor_init_from_real_array", "[simple]") {
		Real x[] = { 1.0, 2.0, 3.0 };
		Vector<Real> a(3, x);
	...
	TEST_CASE("Vector_ctor_negative_size_throws", "[simple]")
	{
	...
	TEST_CASE("Vector_ctor_init_from_std::vector", "[simple]") {
	...
	TEST_CASE("Vector_ctor_initializer_list", "[simple]") {
	...
	TEST_CASE("Test_Vector_access_operators", "[simple]") {
	...
	TEST_CASE("Test_Vector_template_type_deduction", "[simple]") {
